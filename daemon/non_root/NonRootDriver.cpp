...
namespace non_root {
    namespace {
        ...
        public:
            NonRootDriverCounter(DriverCounter * next,
                                 NonRootCounter type,
                                 const char * name,
                                 const char * label,
                                 const char * title,
    ...
    NonRootDriver::NonRootDriver(PmuXML && pmuXml, lib::Span<const GatorCpu> clusters)
        : SimpleDriver("NonRootDriver"), pmuXml(std::move(pmuXml)), clusters(clusters)
    {
    }
    ...
    void NonRootDriver::readEvents(mxml_node_t * /*unused*/)
    {
        ...
        if (canAccessProcLoadAvg) {
            setCounters(
                new NonRootDriverCounter(getCounters(),
                                         ...
                                         "See the description of /proc/loadavg in 'man proc.5' for more details. "
                                         "This counter represents field 1.", //
                                         "average",
                                         "absolute",
                                         nullptr,
                                         "overlay",
                                         1.0 / GlobalStatsTracker::LOADAVG_MULTIPLIER,
                                         false,
                                         false));
            setCounters(
                new NonRootDriverCounter(getCounters(),
                                         ...
                                         "See the description of /proc/loadavg in 'man proc.5' for more details. This "
                                         "counter represents field 2.",
                                         "average",
                                         "absolute",
                                         nullptr,
                                         "overlay",
            ...
            setCounters(
                new NonRootDriverCounter(getCounters(),
                                         ...
                                         "See the description of /proc/loadavg in 'man proc.5' for more details. "
                                         "This counter represents field 3.", //
                                         "average",
                                         "absolute",
                                         nullptr,
                                         "overlay",
            ...
            setCounters(new NonRootDriverCounter(
                ...
                "See the description of /proc/loadavg in 'man proc.5' for more details. This counter represents field "
                "4.", //
                "average",
                "absolute",
                nullptr,
        ...
        if (canAccessProcStat) {
            ...
            setCounters(new NonRootDriverCounter(
                getCounters(),
                NonRootCounter::GLOBAL_DELTA_NUM_FORKS,
            ...
            setCounters(new NonRootDriverCounter(
                getCounters(),
                NonRootCounter::GLOBAL_DELTA_NUM_IRQ,
            ...
            setCounters(new NonRootDriverCounter(
                getCounters(),
                NonRootCounter::GLOBAL_DELTA_NUM_SOFTIRQ,
